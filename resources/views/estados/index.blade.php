...
<div class="card">
    <div class="card-header">Estado
        <a class="btn btn-primary btn-sm float-right text-white" href="{{route('estados.create')}}">Nuevo</a>
    </div>
    <div class="card-body">
        <table id="datatable" class="table table-striped table-bordered dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-light btn-sm" href="{{route('estados.edit', $estado->id)}}">Editar</a>
