...
<div class="card">
    <div class="card-header">Tabla de Prestamos
    ...
    <div class="card-body">
        <table id="datatable" class="table table-striped table-bordered dataTable">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$movimiento->fecha_prestamo}}</td>
                    <td>{{$movimiento->lector->nombres}}</td>
                    <td>
                        @foreach ($movimiento->libros as $p)
                    ...
                    <td>
                        <span class="badge badge-pill"
                            style="background-color: {{$movimiento->estado->color}}; color: green;">{{ $movimiento->estado->nombre }}
                        </span>
                    </td>

                    <td class="text-right">
                        <a class="btn btn-primary btn-sm" href="#">Ver</a>
                        <a class="btn btn-light btn-sm" href="#">Editar</a>
