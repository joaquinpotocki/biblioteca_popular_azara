...
@section('content')
<form class="form-group " method="POST" action="{{route("tipo_bajas.update",$tipo_baja->id)}}">
    @method("PUT")
                ...
                <div class="col-3">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('nombre_baja') is-invalid @enderror" id="nombre_baja"
                            name="nombre_baja" value="{{ old('nombre_baja') ?? $tipo_baja->nombre_baja}}" placeholder="Especifique el tipo de baja" required>
                        @error('nombre_baja')
                ...
                <div class="col-12">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('descripcion') is-invalid @enderror" id="descripcion"
                            name="descripcion" value="{{ old('descripcion') ?? $tipo_baja->descripcion}}" placeholder="Especifique la descripcion del tipo de baja" required>
                        @error('descripcion')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
