...
<div class="card">
    <div class="card-header">Editoriales
        <a class="btn btn-primary btn-sm float-right text-white" href="{{route('editorials.create')}}">Nuevo</a>
    </div>
    <div class="card-body">
        <table id="datatable" class="table table-striped table-bordered dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-light btn-sm" href="{{route('editorials.edit', $editorial->id)}}">Editar</a>
                        <a class="btn btn-danger btn-sm text-white delete" val-palabra={{$editorial->id}}>Borrar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<script>
    ...
    url2="{{route('editorials.destroy',":id")}}";
