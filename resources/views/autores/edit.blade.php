...
@section('content')
<form class="form-group " method="POST" action="{{route("autores.update",$autor->id)}}">
    @method("PUT")
                ...
                <div class="col-3">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('apellido_autor') is-invalid @enderror" id="apellido_autor"
                            name="apellido_autor" value="{{ old('apellido_autor') ?? $autor->apellido_autor}}" placeholder="Especifique el apellido de su numero de serie" required>
                ...
                <div class="col-3">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('nombre_autor') is-invalid @enderror" id="nombre_autor"
                            name="nombre_autor" value="{{ old('nombre_autor') ?? $autor->nombre_autor}}" placeholder="Especifique el nombre de su numero de serie" required>
                        @error('nombre_autor')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
