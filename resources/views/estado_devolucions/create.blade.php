...
<form class="form-group" method="POST" action="{{route("estado_devolucions.store")}}">
    @method('post')
    @csrf
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h5>
                Agregar un nuevo Estado de Devolucion 
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-3">
                    <div class="form-group ">
                        <label for="nombre">Nombre Estado Devolucion</label>
